import { StorexClientAPI_v0, STOREX_HUB_API_v0 } from "./public-api";

export type StorexHubClientRequester<Result = any> = (url: string, options: {
    methodOptions: any
}) => Promise<{ result: Result }>

export async function createStorexHubHttpClient(request: StorexHubClientRequester): Promise<StorexClientAPI_v0> {
    const api: StorexClientAPI_v0 = {} as any
